...
export const Main = props => (
  <div className='main-wrap'>
    ...
    <div className='sidebar'>
      <SidebarPlace
        sidebartitle='About Maple Drive'
        sidebarcontent='Maple Drive is your best resource for FREE, hand-picked, high-quality, commercial-use fonts. Even if that means we send you elsewhere to get them... more info'
      />
      <SidebarPlace
        sidebartitle='New To this website?'
        sidebarcontent='Download our free beginners guide to fonts. Now that you have your guide, its time to use fonts on your website.'
      />
      <SidebarPlace
        sidebartitle='About Maple Drive'
        sidebarcontent='Maple Drive is your best resource for FREE, hand-picked, high-quality, commercial-use fonts. Even if that means we send you elsewhere to get them... more info'
